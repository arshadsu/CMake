...
find_path(TUIO_INCLUDE_DIR
  ...
  PATHS ${TUIO_PKGCONF_INCLUDE_DIRS} ${TUIO_ROOT} $ENV{TUIO_ROOT} $ENV{TUIO_ROOT}/include
)
...
find_library(TUIO_LIBRARY
  NAMES TUIO
  PATHS ${TUIO_PKGCONF_LIBRARY_DIRS} ${TUIO_ROOT} $ENV{TUIO_ROOT} $ENV{TUIO_ROOT}/lib
)
